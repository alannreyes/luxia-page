...
const sections = [
  ...
  { slug: 'docker-networks', titleEs: 'Redes en Docker', titleEn: 'Docker Networks', level: 'chef', icon: '🌐' },
  { slug: 'docker-storage', titleEs: 'Storage en Docker', titleEn: 'Docker Storage', level: 'chef', icon: '💾' },
  { slug: 'ssl-certificates', titleEs: 'Certificados SSL/TLS', titleEn: 'SSL/TLS Certificates', level: 'chef', icon: '🔒' },
  { slug: 'server-security', titleEs: 'Seguridad de Servidor', titleEn: 'Server Security', level: 'chef', icon: '🛡️' },
  { slug: 'security', titleEs: 'Seguridad de Aplicaciones', titleEn: 'Application Security', level: 'chef', icon: '🔐' },
