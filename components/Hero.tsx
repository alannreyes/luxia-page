...
export default function Hero({ dictionary }: BaseComponentProps) {
  ...
  return (
    <>
      <section className="relative pt-32 pb-20 px-6 overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        {/* Background pattern */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <span className="inline-flex items-center px-4 py-2 rounded-full bg-blue-500/10 border border-blue-400/30 text-blue-300 text-sm font-medium backdrop-blur-sm">
          ...
          >
            <motion.button
              ...
              className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-8 py-4 rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 text-lg font-semibold shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30"
            ...
            <motion.button
              ...
              className="border-2 border-white/30 text-white px-8 py-4 rounded-xl hover:bg-white/10 transition-all duration-300 text-lg font-semibold backdrop-blur-sm"
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
            >
          ...
          >
            {dictionary.hero.stats.map((stat: { value: string; label: string }, index: number) => {
              ...
              return (
                <motion.div
                  key={index}
                  className="bg-white/5 backdrop-blur-sm rounded-xl p-4 md:p-6 text-center border border-white/10 hover:border-white/20 transition-all duration-300"
