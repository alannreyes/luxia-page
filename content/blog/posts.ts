...
import { threeVectorsOfAi } from './three-vectors-of-ai'
import { atsDescartaBuenosCandidatos } from './ats-descarta-buenos-candidatos'
...
export const posts: BlogPost[] = [atsDescartaBuenosCandidatos, threeVectorsOfAi, ambientAgents, llmAsValidator, theOtherSideOfTheWall, the70PercentWall]
